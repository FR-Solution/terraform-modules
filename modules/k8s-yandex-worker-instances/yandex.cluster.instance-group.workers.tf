...
#   instance_template {
#     hostname = "worker-{instance.index}-${var.k8s_global_vars.cluster_name}"
#     name = "worker-{instance.index}-${var.k8s_global_vars.cluster_name}"
...
#         user-data = var.cloud_init_template.worker["worker-1"]
#     }
#     network_settings {
#       type = "STANDARD"
