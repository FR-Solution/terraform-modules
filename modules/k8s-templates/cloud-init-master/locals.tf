...
output "test" {
  value = module.kubelet-service-master.kubelet-service-args["master-1"]
}
# locals {
#   cloud-init-template = flatten([
#     for master_name, master_content in  local.master_instance_list_map:
...
#         # bootstrap_token_all               = var.vault-bootstrap-master-token["master-1"].client_token
...
#         kubelet-service-args                = module.kubelet-service-master.kubelet-service-args["master-1"]
#         kubelet-config                      = module.kubelet-service-master.kubelet-config

#         key-keeper-config                   = module.key-keeper-service-master.key-keeper-config["master-1"]
#         key-keeper-service                  = module.key-keeper-service-master.key-keeper-service

#         static-pod-etcd                     = module.static-pod-etcd.manifest["master-1"]
#         static-pod-kubeadm-config           = module.static-pod-kubeadm-config.manifest["master-1"]
#         # static-pod-kube-apiserver           = module.static-pod-kube-apiserver.manifest["master-1"]
#         # static-pod-kube-controller-manager  = module.static-pod-kube-controller-manager.manifest["master-1"]
#         # static-pod-kube-scheduler           = module.static-pod-kube-scheduler.manifest["master-1"]
