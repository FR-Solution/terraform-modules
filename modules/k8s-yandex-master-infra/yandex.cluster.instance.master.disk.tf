resource "yandex_compute_disk" "etcd" {
  ...
  zone = try(var.k8s_global_vars.master_vars.master_group.resources_overwrite[split("_", each.key)[1]].network_interface.zone, var.k8s_global_vars.master_vars.master_group.default_zone)
